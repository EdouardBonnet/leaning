...
theorem gridMinor_or_strong_pathOfSets_minor_of_hairy_pathOfSets_of_transcript_and_targetProviders
    (hproviders :
      ∃ cRound cScale : ℕ, 0 < cRound ∧ 0 < cScale ∧
        _root_.SimpleGraph.HairyCrossbarGrid.FixedRoundCutMatchingTranscriptProvider.{u}
          cRound ∧
          _root_.SimpleGraph.HairyCrossbarGrid.FixedRoundExpanderTargetProvider
            cRound cScale) :
  ...
  rcases local_crossbars_at_odd_clusters_or_strong_pathOfSets_minor with
    ⟨cCross, hcCross, hodd⟩
  rcases
    _root_.SimpleGraph.HairyCrossbarGrid.exists_gridMinor_of_hairy_pathOfSets_and_crossbars_of_transcript_and_target
      hproviders with
    ⟨cGrid, hcGrid, hgrid⟩
  ...
  gridMinor_or_strong_pathOfSets_minor_of_hairy_pathOfSets_of_transcript_and_targetProviders
    (by
      ...
      exact ⟨cRound, cScale, hcRound, hcScale,
        _root_.SimpleGraph.HairyCrossbarGrid.fixedRoundCutMatchingTranscriptProvider_of_unbundled
          hunbundled,
        htarget⟩)
...
theorem gridMinor_or_strong_pathOfSets_minor_of_hairy_pathOfSets_of_unbundledCutMatching
  ...
  exact
    gridMinor_or_strong_pathOfSets_minor_of_hairy_pathOfSets_of_unbundledCutMatching_and_targetProviders
      ⟨cRound,
        _root_.SimpleGraph.HairyCrossbarGrid.fixedRoundExpanderTargetScale
          cRound,
        hcRound,
        _root_.SimpleGraph.HairyCrossbarGrid.fixedRoundExpanderTargetScale_pos
          cRound,
        hunbundled,
        _root_.SimpleGraph.HairyCrossbarGrid.fixedRoundExpanderTargetProvider_explicit
          cRound⟩
...
theorem gridMinor_or_gridMinor_of_subgraph_hairy_pathOfSets_with_scaled_strong_parameter_of_inputs_and_unbundledCutMatching_and_targetProviders
  ...
  rcases local_crossbars_at_odd_clusters_or_strong_pathOfSets_minor_of_crossbarDichotomy
    ...
    ⟨cCross, hcCross, hodd⟩
  rcases
    _root_.SimpleGraph.HairyCrossbarGrid.exists_gridMinor_of_hairy_pathOfSets_and_crossbars_of_unbundled_and_target
      hproviders with
    ⟨cGrid, hcGrid, hgrid⟩
